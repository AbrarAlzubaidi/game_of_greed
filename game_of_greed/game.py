...
#                 nums.append(str(i))
#             print(','.join(nums))
#             decision = int(input('Enter dice to keep (no spaces), or (q)uit: '))
...
#             if decision1=="b":
#                 print ("You banked 100 points in round 1")
#                 print ("Total score is 100 points")
...
#             if decision3=="b":
#                 print ("You banked 100 points in round 2")
